...
function setPropCreateCounterparty() {
  var stateTask = EdocsApi.getCaseTaskDataByCode("ChecknewCounterparty")?.state;
  if (stateTask == "completed") {
    if (EdocsApi.getAttributeValue("counterparty").value) setPropertyHidden("CreateCounterparty", false);
  } else {
